...
import { setOverheadPctAction, setRepSplitAction } from "@/server/modules/costs/actions";
    ...
    <div className="space-y-5 rounded-xl border border-border bg-card p-5">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          For each deal: contract − job cost − company overhead = profit pool, split between the company and the rep by each rep&rsquo;s %.
        </p>
      </div>
