...
/**
 * The payroll LIST only — in a route group so this boundary cannot reach payroll/[id], which must stay able to answer 404.
 *
 ...
 */
export default function PayrollIndexLoading() {
  return <PageSkeleton />;
}
