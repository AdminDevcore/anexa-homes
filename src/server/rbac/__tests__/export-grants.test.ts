...
describe("export grants", () => {
  ...
  it("Bookkeeping exports are the funding desk and the owner", () => {
    expectExport("Bookkeeping", ["super_admin", "accounting"]);
  });
  ...
  /** Unchanged — recorded so a matrix edit has to come past this file. */
