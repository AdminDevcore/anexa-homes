...
/**
 * The documents LIST only — in a route group so this boundary cannot reach documents/[id], which must stay able to answer 404.
 *
 ...
 */
export default function DocumentsIndexLoading() {
  return <PageSkeleton />;
}
